...
TRACKS_CONFIG = [
    ...
    {"id": "srcc", "name": "Pure UG Good Placement (SRCC)", "short": "Pure UG Good Placement", "cluster": "Undergrad Direct (No MBA)", "cluster_id": "ug", "color": "#c084fc", "fee": 1.2, "loan": 0.0, "rate": 0.0, "dur": 0, "start_ctc": 14.4, "start_cash": 9.9, "benefits": 4.5,
     "hike_schedule": [
     ...
     "g1": 0.149, "g2": 0.108, "g3": 0.058, "ceiling_role": "Director / Principal (Advisory / GCC)", "ceiling_ctc": "₹75L - ₹95L (₹65L-₹80L fixed cash)", "ceiling_notes": "Calibrated to verified ₹14.4L CTC offer (e.g. Oxane / top-tier finance & consulting). Uses Path B organic progression without assuming lateral switches. Caps at Director level without MBA/partner equity."},
    {"id": "srcc_median", "name": "SRCC Median Placement (Pure UG)", "short": "SRCC Median Placement", "cluster": "Undergrad Direct (No MBA)", "cluster_id": "ug", "color": "#e879f9", "fee": 1.2, "loan": 0.0, "rate": 0.0, "dur": 0, "start_ctc": 8.5, "start_cash": 7.65, "benefits": 0.85,
     "hike_schedule": [
         0.10,   # Y2: 10% annual merit
         0.20,   # Y3: 20% promotion to Senior Analyst (Month 24)
         0.10,   # Y4: 10% annual merit
         0.10,   # Y5: 10% annual merit
         0.20,   # Y6: 20% promotion to Associate / Lead (Month 60)
         0.09,   # Y7: 9% annual merit
         0.09,   # Y8: 9% annual merit
         0.18,   # Y9: 18% promotion to Manager (Month 96)
     ...
     "g1": 0.149, "g2": 0.108, "g3": 0.058, "ceiling_role": "Director / Senior Delivery Lead", "ceiling_ctc": "₹55L - ₹70L (₹45L-₹58L fixed cash)", "ceiling_notes": "Official SRCC audited campus median placement (~₹8.5L CTC). Follows single-firm Path B organic progression to Director/Senior Delivery Lead."},
